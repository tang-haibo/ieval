(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ieval = {}));
    ...
    ***************************************************************************** */
    ...
    var name = "ieval";
    var version$1 = "1.0.1";
    var description = "js在微信小程序等环境实现远程载入其他实现库进行调用";
    var main = "./lib/";
    var scripts = {
    ...
    var author = "tang-haibo";
    var license = "(MIT OR Apache-2.0)";
    var bugs = {
    	url: "https://github.com/tang-haibo/ieval/issues"
    };
    var homepage = "https://github.com/tang-haibo/ieval#readme";
    var devDependencies = {
    	"@babel/parser": "^7.15.2",
    ...
    var Interpreter = /** @class */ (function () {
        function Interpreter(context, options) {
            ...
            this.source = '';
            this.sourceList = [];
            this.currentScope = new Scope({}, null, RootScopeName);
            this.globalScope = new Scope({}, null, GlobalScopeName);
            this.currentContext = {};
        ...
        Interpreter.prototype.getWindow = function () {
            return this.globalScope.data;
        };
        ...
        Interpreter.prototype.nullLiteral = function (_node) {
            return function () {
                return null;
            };
        };
        Interpreter.prototype.baseLiteral = function (node) {
            var _this = this;
            return function () {
                return _this.getLiteralValue(node);
            };
        };
        Interpreter.prototype.regExpLiteral = function (node) {
            return function () {
                return new RegExp(node.pattern, node === null || node === void 0 ? void 0 : node.flags);
            };
        };
        ...
        Interpreter.prototype.binaryExpressionHandler = function (node) {
            ...
            return function () {
                ...
                switch (node.operator) {
                    ...
                    default:
                        throw _this.createInternalThrowError(Messages.BinaryOperatorSyntaxError, node.operator, node);
                }
            };
        };
        // a && b
            ...
            return function () {
                switch (node.operator) {
                    ...
                    case "&&":
                        return leftExpression() && rightExpression();
                    default:
                        throw _this.createInternalThrowError(Messages.LogicalOperatorSyntaxError, node.operator, node);
                }
            };
        };
                    ...
                    return function () {
                        ...
                        switch (node.operator) {
                            ...
                            case "typeof":
                                return typeof value;
                            default:
                                throw _this.createInternalThrowError(Messages.UnaryOperatorSyntaxError, node.operator, node);
                        }
                    };
            }
        };
            ...
            return function () {
                ...
                switch (node.operator) {
                    ...
                    case "--":
                        return node.prefix ? --obj[name] : obj[name]--;
                    default:
                        throw _this.createInternalThrowError(Messages.UpdateOperatorSyntaxError, node.operator, node);
                }
            };
        };
        Interpreter.prototype.isLiteral = function (type) {
            return type === 'RegExpLiteral' ||
                type === 'NumericLiteral' ||
                type === 'StringLiteral' ||
                type === 'Literal';
        };
        Interpreter.prototype.getLiteralValue = function (keyNode) {
            var _a, _b, _c, _d;
            if (((_a = keyNode === null || keyNode === void 0 ? void 0 : keyNode.extra) === null || _a === void 0 ? void 0 : _a.rawValue) !== undefined) {
                return (_b = keyNode === null || keyNode === void 0 ? void 0 : keyNode.extra) === null || _b === void 0 ? void 0 : _b.rawValue;
            }
            if (((_c = keyNode === null || keyNode === void 0 ? void 0 : keyNode.extra) === null || _c === void 0 ? void 0 : _c.raw) !== undefined) {
                return (_d = keyNode === null || keyNode === void 0 ? void 0 : keyNode.extra) === null || _d === void 0 ? void 0 : _d.raw;
            }
            if ((keyNode === null || keyNode === void 0 ? void 0 : keyNode.init.value) !== undefined) {
                return keyNode === null || keyNode === void 0 ? void 0 : keyNode.init.value;
            }
            return keyNode === null || keyNode === void 0 ? void 0 : keyNode.value;
        };
        ...
        Interpreter.prototype.objectExpressionHandler = function (node) {
            ...
            function getKey(keyNode) {
                ...
                // else if (keyNode.type === "Literal") {
                    ...
                    return String(self.getLiteralValue(keyNode));
                }
                else {
            ...
            node.properties.forEach(function (property) {
                ...
                var key = getKey(prop.key);
                if (!properties[key] || kind === "init") {
                    properties[key] = {};
                }
                properties[key][kind] = _this.createClosure(prop.value);
                items.push({
                    key: key,
                    property: prop,
                });
                ...
                case "MemberExpression":
                    ...
                    return function () {
                        ...
                        if (!func || !isFunction(func)) {
                            var name = source_1.slice(node.start, node.end);
                            throw _this.createInternalThrowError(Messages.FunctionUndefinedReferenceError, name, node);
                        }
                        // obj.eval = eval
                        // obj.eval(...)
                        ...
                        if (func.__IS_FUNCTION_FUNC) {
                            return function () {
                                ...
                                return func.apply(void 0, __spreadArray([new InternalInterpreterReflection(_this)], args));
                            };
                        }
                        // method call
                        // eg：obj.say(...)
        ...
        Interpreter.prototype.newExpressionHandler = function (node) {
            ...
            return function () {
                ...
                if (!isFunction(construct) || construct.__IS_EVAL_FUNC) {
                    ...
                    throw _this.createInternalThrowError(Messages.IsNotConstructor, name, node);
                }
                // new Function(...)
                if (construct.__IS_FUNCTION_FUNC) {
                    return construct.apply(void 0, __spreadArray([new InternalInterpreterReflection(_this)], args.map(function (arg) { return arg(); })));
                }
                return new (construct.bind.apply(construct, __spreadArray([void 0], args.map(function (arg) { return arg(); }))))();
            };
        };
        // a.b a['b']
            ...
            return function () {
                ...
                switch (node.operator) {
                    ...
                    case "|=":
                        return (data[name] |= rightValue);
                    default:
                        throw _this.createInternalThrowError(Messages.AssignmentExpressionSyntaxError, node.type, node);
                }
            };
        };
        // function test(){}
    ...
    function EvalScript(ast, context) {
        // 新建执行上下文
        var interpreter = new Interpreter(context || {});
        // 批量执行
        ast.forEach(function (code) {
    ...
    var CodeType;
    (function (CodeType) {
        CodeType[CodeType["NETWORK"] = 1] = "NETWORK";
        CodeType[CodeType["CODE"] = 2] = "CODE";
        CodeType[CodeType["AST"] = 3] = "AST";
    })(CodeType || (CodeType = {}));
    var CodeBlock = /** @class */ (function () {
        function CodeBlock(type, value) {
            var _this = this;
            this.value = '';
            this._loaded = false;
            this.type = 1;
            ...
            if (type === CodeType.NETWORK) {
                ...
                request(value).then(function (code) {
                    _this.value = code;
                    _this._loaded = true;
                    _this.resolves.forEach(function (resolve) { return resolve(0); });
                });
                return;
            }
            this.value = value;
        ...
        CodeBlock.prototype.loaded = function () {
    ...
    var request;
    // 建同一个文档
    var DocumentEval = /** @class */ (function () {
        function DocumentEval(context) {
            // 调用迭代器
            this.resolve = null;
            // 资源列表
            this.resouces = [];
        ...
        DocumentEval.setNetwork = function (reqFunc) {
            request = reqFunc;
        };
        // 添加代码执行
        DocumentEval.prototype.appendCode = function (code) {
            this.resouces.push(new CodeBlock(CodeType.CODE, code));
        };
        // 载入远程代码
        DocumentEval.prototype.appendUrl = function (url) {
            this.resouces.push(new CodeBlock(CodeType.NETWORK, url));
        };
        // 载入Ast
        DocumentEval.prototype.appendAst = function (ast) {
            this.resouces.push(new CodeBlock(CodeType.AST, ast));
        };
        // 确保资源全部加载完成
        DocumentEval.prototype.loaded = function () {
            return Promise.all(this.resouces.map(function (resouce) { return resouce.loaded(); }));
        };
        DocumentEval.prototype.getWindow = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            // 重建环境重新执行一次
                            this.ctx = EvalScript(this.resouces.map(function (item) { return item.value; }), this.context);
                            return [2 /*return*/, this.ctx.getWindow()];
                    }
                });
            });
        };
    ...
    function iEval(resouces, context) {
        var documentEval = new DocumentEval(context);
        // 代码由上至下注入
        resouces.forEach(function (resouce) {
            if (isString(resouce)) {
                documentEval.appendCode(resouce);
            }
            else if (isNetworkUrl(resouce)) {
                documentEval.appendUrl(resouce);
            }
            else if (isJSON(resouce)) {
                documentEval.appendAst(resouce);
            }
        });
    }
    // 设置代码拉取函数
    ...
    var index = {
        ...
        DocumentEval: DocumentEval,
        iEval: iEval
    };

    exports.DocumentEval = DocumentEval;
