(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.remoteImport = {}));
    ...
    ***************************************************************************** */
    ...
    var repository = {
    	type: "git",
    	url: "https://github.com/tang-haibo/remote-import.git"
    };
    var keywords = [
    	"remote-import",
    	"wx-import",
    ...
    var bugs = {
    	url: "https://github.com/tang-haibo/remote-import/issues"
    };
    var homepage = "https://github.com/tang-haibo/remote-import#readme";
    var devDependencies = {
    	"@babel/parser": "^7.15.2",
    ...
    // 各端实现不一致，这里实现被忽略
    function getResource(url, option) {
        return option.get(url);
    }
    function loadCode(scripts, option) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.all(scripts.map(function (item) {
    ...
    // 远程代码载入执行
    function ImportScript(scripts, option) {
        return __awaiter(this, void 0, Promise, function () {
            var code, context;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loadCode(scripts, option)];
                    case 1:
                        code = _a.sent();
                        context = option.context;
                        return [2 /*return*/, EvalScript(code, context)];
                }
            });
        });
    }
